...
describe('Block', ()=> {
    ...
    describe('mineBlock()',()=>{
        ...
        it('sets the `lastHash` value to be equal to the `hash` of the lastBlock',()=>{
        ...
        it('sets a SHA 256 generated `hash`',()=>{
        ...
        it('adjust the difficulty of the minedBlock',() => {
    ...
    describe('adjustDifficulty()',() => {
        it('raises the difficulty for a quickly added minedBlock', () => {
            expect(Block.adjustDifficulty( { originalBlock: block, timestamp: block.timestamp + MINE_RATE -100 } )).toEqual(block.difficulty+1);
        });
        it('lowers the difficulty for a slowly added minedBlock',() => {
            expect(Block.adjustDifficulty( {originalBlock: block, timestamp: block.timestamp + MINE_RATE + 100})).toEqual(block.difficulty-1);
        });
        it('has a lower limit difficulty value of 1', () => {
            block.difficulty = -1;
